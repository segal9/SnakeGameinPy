from tkinter import * # need to see the game run
import random

GAME_WIDTH = 750
GAME_HEIGHT = 600
SPEED = 100 # if too fast make it a higher number like 150
SPACE_SIZE = 50
BODY_PARTS = 3
SNAKE_COLOR = "#00FF00"
FOOD_COLOR = "#FF0000"
...
class Food:
    ...
    def __init__(self):
        # used the // to ensure integer division
...
def next_turn(snake, food):
    ...
    if x == food.coordinates[0] and y == food.coordinates[1]:
        ...
        # saved old formate, to change it so that the score updates:
        #if x == food.coordinates[0] and y == food.coordinates[1]:
        score += 1
        update_score()
        canvas.delete("food")
